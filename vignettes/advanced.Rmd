...
You can use the `define` method to define global variables. This can make things clearer and more efficient.
...
Note that these variables are referred to b their bare (unquoted) names in the `change` method.
